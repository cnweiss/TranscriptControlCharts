#Simulate out-of-control zero-state ARL for Delta_K chart:
...
#Delta_K chart:
# cl <- 3.19 #370.3659	366.542140808666
# cl <- 0.8078 #369.74663	363.646044579204
cl <- 0.3229 #369.61303	357.850732506847
