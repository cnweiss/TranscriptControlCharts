#Simulate out-of-control zero-state ARL for mu_K chart:
...
#mu_K chart:
# cl <- 1.0188 #369.79243	366.628526371665
# cl <- 0.5827 #370.31036	360.835611546388
cl <- 0.3785 #370.53761	357.443101907421
